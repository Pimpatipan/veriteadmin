    ...
    <form class="form-box">
      <b-container class="container-box">
        <b-row class="no-gutters">
          <b-col>
            <h1 class="font-weight-bold text-uppercase">Import Tracking No.</h1>
          </b-col>
        </b-row>
        ...
        <b-row class="no-gutters bg-white-border mt-4">
          <b-col class="px-4 px-sm-5 py-4">
            ...
            <b-row class="mt-5">
              <b-col md="6">
                <b-button href="/order" class="btn-details-set">CANCEL</b-button>
              </b-col>
  ...
  methods: {
    ...
    submit: async function(id) {
      ...
      let data = await this.$callApi(
        "post",
        `${this.$baseUrl}/api/transaction/importTrackingNo`,
        null,
        this.$headers,
        this.form
      );
