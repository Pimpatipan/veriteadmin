<template>
  <CContainer class="min-vh-100">
    <CRow class="no-gutters px-3 px-sm-0">
      <b-col cols="8" sm="6">
        <h1 class="mr-sm-4 header">SKIN CONSULTATION LIST</h1>
      </b-col>
      <b-col cols="4" sm="6" class="text-right">
        ...
        <router-link to="/skinconsultation/details/0">
      ...
      <b-row class="no-gutters mt-3">
        <b-col lg="6">
          <b-input-group class="panel-input-serach">
            <b-form-input class="input-serach" @keyup="handleSearch" placeholder="Name" v-model="filter.search"></b-form-input>
          ...
          >
            ...
            <template v-slot:cell(id)="data">
              <div class="d-flex justify-content-center">
                <router-link :to="'/skinconsultation/details/'+data.item.id">
  ...
  methods: {
    getList: async function() {
      ...
      let data = await this.$callApi(
        "post",
        `${this.$baseUrl}/api/skinConsult/list`,
        null,
        this.$headers,
        this.filter
      );
    ...
    deleteData: async function(id) {
      if (confirm("Are you sure you want to delete this data?") == true) {
        let data = await this.$callApi(
          "delete",
          `${this.$baseUrl}/api/skinConsult/removeSkinConsult/${id}`,
          null,
          this.$headers,
          null
        );
